...
def main():
    ...
    submit_file_parser.add_argument("--file", type=str, required=True, help="Path to source file (e.g., src.hpp)")
    submit_file_parser.add_argument("--language", type=str, default="cpp", help="Language key (default: cpp)")
